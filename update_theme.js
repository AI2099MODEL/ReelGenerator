...
val EBGaramond = FontFamily(
    ...
    Font(googleFont = GoogleFont("EB Garamond"), fontProvider = provider, weight = FontWeight.SemiBold)
)

val SourceSans3 = FontFamily(
    Font(googleFont = GoogleFont("Source Sans 3"), fontProvider = provider, weight = FontWeight.Normal),
    Font(googleFont = GoogleFont("Source Sans 3"), fontProvider = provider, weight = FontWeight.Medium),
